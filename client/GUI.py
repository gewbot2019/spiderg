...
def servo_buttons(x,y):
	...
	Btn_3 = tk.Button(root, width=8, text='Lean-L',fg=color_text,bg=color_btn,relief='ridge')
	Btn_3.place(x=x,y=y)
	...
	Btn_4 = tk.Button(root, width=8, text='Lean-R',fg=color_text,bg=color_btn,relief='ridge')
	...
	Btn_5 = tk.Button(root, width=8, text='StayLow',fg=color_text,bg=color_btn,relief='ridge')
	...
	Btn_6 = tk.Button(root, width=8, text='StandUp',fg=color_text,bg=color_btn,relief='ridge')
...
def function_buttons(x,y):
	...
	Btn_function_1 = tk.Button(root, width=8, text='Steady',fg=color_text,bg=color_btn,relief='ridge')
	...
	Btn_function_4 = tk.Button(root, width=8, text='Diagonal',fg=color_text,bg=color_btn,relief='ridge')
	Btn_function_5 = tk.Button(root, width=8, text='Action 1',fg=color_text,bg=color_btn,relief='ridge')
	Btn_function_6 = tk.Button(root, width=8, text='Action 2',fg=color_text,bg=color_btn,relief='ridge')
